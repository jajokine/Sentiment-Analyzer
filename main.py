...
# Fix values for L and T while tuning Pegasos T and L
fix_L = 0.01
...
#           accurate algorithm with the optimal choice of hyperparameters to get the best      #
#           explanatory word features                                                          #
# ---------------------------------------------------------------------------------------------#
